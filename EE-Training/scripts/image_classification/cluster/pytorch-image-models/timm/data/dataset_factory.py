...
from imagenet_msgpack_dataset import ImageNetMsgpackDataset
...
def create_dataset(
    ...
    if name.startswith('torch/'):
        ...
        if name == 'msgpack':
            msgpack_file = os.path.join(root, 'train.msgpack' if is_training else 'val.msgpack')
            return ImageNetMsgpackDataset(
                msgpack_file,
                transform=kwargs.get("transform", None),
                max_samples=kwargs.get("num_samples", None)
            )
